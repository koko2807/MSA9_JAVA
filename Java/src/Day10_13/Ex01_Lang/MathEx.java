...
public class MathEx {
	...
	public static void main(String[] args) {
		...
		// (0.0xxx~0.9xxx) * 10 	: 0xxx~9xxx			(0 ~ 9) - 10개
		// (0.0xxx~0.9xxx) * 20 	: 0xxx~19xxx		(0 ~ 19) - 20개
		// (0.0xxx~0.9xxx) * 45 	: 0xxx~44xxx		(0 ~ 44) - 45개
		// (0.0xxx~0.9xxx) * 45 + 1 : 0xxx~4xxx		(1 ~ 45)
		// (int)(Math.random() * 45 + 1)	: 1~45
		
		// [공식]
		// (int)(Math.randomj() * [개수] + [시작숫자])
